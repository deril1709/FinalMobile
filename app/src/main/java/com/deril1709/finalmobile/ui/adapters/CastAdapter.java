package com.deril1709.finalmobile.ui.adapters;
...
import com.deril1709.finalmobile.R;
import com.deril1709.finalmobile.data.models.Cast;

import java.util.List;

public class CastAdapter extends RecyclerView.Adapter<com.deril1709.finalmobile.ui.adapters.CastAdapter.CastViewHolder> {
    ...
    @NonNull
    @Override
    public com.deril1709.finalmobile.ui.adapters.CastAdapter.CastViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_cast_recycler, parent, false);
        return new com.deril1709.finalmobile.ui.adapters.CastAdapter.CastViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull com.deril1709.finalmobile.ui.adapters.CastAdapter.CastViewHolder holder, int position) {
